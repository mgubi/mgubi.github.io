...
<\body>
  ...
  20101130<strong|> - poly 3 - v.4]>>

  <chapter|Comportement asymptotique des martingales>

  <section|Convergence presque sure>

  On rappelle que une sur-martingale <math|(X<rsub|n>)<rsub|n\<geqslant\>1>>
  ...
  <math|\<bbb-E\>[\<Delta\>X<rsub|n>\|\<cal-F\><rsub|n-1>]\<leqslant\>0> : en
  moyenne on perd<strong|>.\ 
  ...
  <math|U<rsub|n>(a,b)> le nombre de fois que
  <math|(X<rsub|k>)<rsub|1\<leqslant\>k\<leqslant\>n>> passe de
  <math|]-\<infty\>,a[> à <math|]b,+\<infty\>[> et <math|W<rsub|n>> notre
  gain en utilisant la stratégie \ décrite on a que

  <\equation>
    W<rsub|n>-W<rsub|0>\<geqslant\>(b-a)U<rsub|n>(a,b)-(X<rsub|n>-a)<rsub|-><label|eq:upcorssing>
  </equation>

  Le terme <math|(X<rsub|n>-a)<rsub|->> corresponds à ce que on a
  eventuellement perdu dans la derniére montée avant d'atteindre <math|b>. Il
  est aussi facile voir que <math|(W<rsub|n>)<rsub|n\<geqslant\>1>> est une
  sur-martingale car on peut écrire

  <\equation*>
    W<rsub|n>=W<rsub|0>+<big|sum><rsub|k=1><rsup|n>H<rsub|n>*\<Delta\>X<rsub|n>
  </equation*>

  avec <math|H<rsub|n>=<big|sum><rsub|i=1><rsup|\<infty\>>\<bbb-I\><rsub|S<rsub|i>\<leqslant\>n\<leqslant\>T<rsub|i>-1>=\<bbb-I\><rsub|{n\<in\>\<cup\><rsub|i\<geqslant\>1>[S<rsub|i>,T<rsub|i>-1]}>>.
  De façon équivalente on peut définir <math|(H<rsub|n>)<rsub|n\<geqslant\>1>>
  ...
  Alors <math|U<rsub|n>(a,b)=<big|sum><rsub|i=2><rsup|n>
  \<bbb-I\><rsub|H<rsub|n>=0,H<rsub|n-1>=1>>.

  <\exercise>
    Montrer que <math|(H<rsub|n>)<rsub|n\<geqslant\>1>> est un processus
    prévisible.
  </exercise>

  Pour montrer que l'équation (<reference|eq:upcorssing>) est satisfaite pour
  tout <math|n> on définit <math|T<rsub|n>=sup(0\<leqslant\>k\<leqslant\>n
  :H<rsub|k>=0)>. C'est le dernier instant avant <math|n> où on recommence la
  stratégie d'achat. Ce n'est pas un temps d'arrêt. À ce moment,
  <math|X<rsub|T<rsub|n>>\<less\>a>, <math|U<rsub|n>(a,b)=U<rsub|T<rsub|n>>(a,b)>
  ...
  <math|W<rsub|T<rsub|n>>-W<rsub|0>\<geqslant\>(b-a)U<rsub|T<rsub|n>>(a,b)>
  car chaque traversée montante il nous fait gagner au moins <math|(b-a)>.
  Alors

  <\equation*>
    W<rsub|n>-W<rsub|0>=W<rsub|T<rsub|n>>-W<rsub|0>+X<rsub|n>-X<rsub|T<rsub|n>>\<geqslant\>(b-a)U<rsub|T<rsub|n>>(a,b)+X<rsub|n>-a
  </equation*>

  <\equation*>
    =(b-a)U<rsub|n>(a,b)+(X<rsub|n>-a)<rsub|+>-(X<rsub|n>-a)<rsub|->
  </equation*>

  <\equation*>
    \<geqslant\>(b-a)U<rsub|n>(a,b)-(X<rsub|n>-a)<rsub|-> .
  </equation*>

  Du fait que <math|(H<rsub|n>)<rsub|n\<geqslant\>1>> est prévisible et que
  <math|0\<leqslant\>H<rsub|n>> on obtient que
  <math|(W<rsub|n>)<rsub|n\<geqslant\>1>> est une sur-martingale :

  <\equation*>
    0\<geqslant\>\<bbb-E\>[W<rsub|n>-W<rsub|0>]\<geqslant\>\<bbb-E\>[U<rsub|n>(a,b)](b-a)-\<bbb-E\>[(X<rsub|n>-a)<rsub|->]
  </equation*>

  (dans un jeu défavorable, tout stratégie ne peut qu'apporter des pertes en
  moyenne). On en déduit donc le lemme suivante (car
  <math|\<bbb-E\>[(X<rsub|n>-a)<rsub|->]\<leqslant\>\<bbb-E\>[(X<rsub|n>-a)<rsub|->]+\<bbb-E\>[(X<rsub|n>-a)<rsub|+>]=\<bbb-E\>[\|X<rsub|n>-a\|]>)
  ...
  <\lemma>
    ...
    <\equation*>
      \<bbb-E\>[U<rsub|n>(a,b)]\<leqslant\><frac|\<bbb-E\>[\|X<rsub|n>-a\|]|b-a>
    </equation*>
  </lemma>

  ce qui donne une estimation du nombre de tranversées montantes de
  l'intervalle <math|[a,b]> par le processus
  <math|(X<rsub|k>)<rsub|1\<leqslant\>k\<leqslant\>n>> en fonction d'une
  moyenne sur sa valeur terminale. Une conséquence importante pour les
  sur-martingales bornées dans <math|L<rsup|1>> est donnée par le corollaire
  suivante:

  <\corollary>
    Soit <math|(X<rsub|n>)<rsub|n\<geqslant\>1>> une sur-martingale bornée
    dans <math|L<rsup|1>>(c-à-d <math|sup<rsub|n>\<bbb-E\>[\|X<rsub|n>\|]\<less\>+\<infty\>>),
    alors si on note <math|U(a,b)=sup<rsub|n\<geqslant\>1>U<rsub|n>(a,b)> le
    nombre de traversées de l'intervalle <math|[a,b]> par
    <math|(X<rsub|n>)<rsub|n\<geqslant\>1>> on a que
  ...
  <\proof>
    ...
    <\equation*>
      \<bbb-E\>[U<rsub|n>(a,b)]\<leqslant\><frac|a+\<bbb-E\>[\|X<rsub|n>\|]|b-a>\<leqslant\><frac|a+sup<rsub|n>\<bbb-E\>[\|X<rsub|n>\|]|b-a>\<less\>+\<infty\>
    </equation*>
    ...
    <\equation*>
      \<bbb-E\>[U(a,b)]=lim<rsub|n\<rightarrow\>\<infty\>>\<bbb-E\>[U<rsub|n>(a,b)]\<leqslant\><frac|a+sup<rsub|n>\<bbb-E\>[\|X<rsub|n>\|]|b-a>\<less\>+\<infty\>
    </equation*>

    et donc que <math|\<bbb-P\>(U(a,b)=+\<infty\>)=0> pour tout
    <math|a\<less\>b>.\ 
  </proof>
  ...
  <\theorem>
    (<name|Doob>) Une sous-martingale <math|(X<rsub|n>)<rsub|n\<geqslant\>1>>
  ...
  <\proof>
    ...
    <math|\<bbb-P\>(L<rsub|->\<less\>L<rsub|+>)\<gtr\>0> (c-à-d
    <math|Y<rsub|n>> ne converge pas p.s.). Par continuité de la probabilité
    <math|\<bbb-P\>> il existent <math|a\<less\>b> tels que
    <math|\<bbb-P\>(L<rsub|->\<less\>a\<less\>b\<less\>L<rsub|+>)\<gtr\>0>.
    Or

    <\equation*>
      {L<rsub|->\<less\>a\<less\>b\<less\>L<rsub|+>}\<subseteq\>{U(a,b)=+\<infty\>}
    </equation*>

    et on obtient donc que <math|\<bbb-P\>(U(a,b)=+\<infty\>)\<gtr\>0> en
    contradiction avec la conséquence de la bornitude en <math|L<rsup|1>> de
    <math|(Y<rsub|n>)<rsub|n\<geqslant\>1>>. Donc on doit avoir
    <math|\<bbb-P\>(L<rsub|->\<less\>L<rsub|+>)=0> ce que donne la
    convergence p.s. de <math|(Y<rsub|n>)<rsub|n>> vers
    <math|Y=L<rsub|->=L<rsub|+>> et donc de
    <math|(X<rsub|n>)<rsub|n\<geqslant\>1>> vers <math|X=-Y>. Or, par Fatou,
    <math|\<bbb-E\>[\|X\|]=\<bbb-E\>[liminf<rsub|n>\|X\|]\<leqslant\>liminf<rsub|n>\<bbb-E\>[\|X<rsub|n>\|]\<less\>+\<infty\>>
  ...
  <\theorem>
    (<name|Doob>) Une sur-martingale <math|(X<rsub|n>)<rsub|n\<geqslant\>1>>
    positive converge p.s. vers une v.a. <math|X\<in\>L<rsup|1>>.
  </theorem>

  <\proof>
    On a que <math|\<bbb-E\>[\|X<rsub|n>\|]=\<bbb-E\>[X<rsub|n>]\<leqslant\>\<bbb-E\>[X<rsub|0>]>
  ...
  <\exercise>
    ...
    <math|\<bbb-P\>(X\<gtr\>0)\<gtr\>0> alors il existe
    <math|\<varepsilon\>\<gtr\>0> tel que
    <math|\<bbb-P\>(X\<gtr\>\<varepsilon\>)\<gtr\>0> (Sugg: considérer les
    événements <math|{X\<leqslant\>1/n}> et montrer que si
    <math|\<bbb-P\>(X\<geqslant\>1/n)=0> alors
    <math|\<bbb-P\>(X\<gtr\>0)=0>).
  </exercise>

  <\exercise>
    Montrer que <math|{L<rsub|->\<less\>a\<less\>b\<less\>L<rsub|+>}\<subseteq\>{U(a,b)=+\<infty\>}>
    pour tout <math|a\<less\>b>.
  </exercise>
  ...
  <\proof>
    ...
    <math|L<rsup|2>(\<Omega\>)>. Comme la martingale est aussi bornée dans
    <math|L<rsup|1>\<subseteq\>L<rsup|2>> alors
    ...
    existe une sous-suite <math|(n<rsub|k>)<rsub|k\<geqslant\>1>> telle que
    <math|M<rsub|n<rsub|k>>> converge p.s. vers <math|M<rsub|\<infty\>>>.
    Mais alors <math|M<rsub|\<infty\>>=lim<rsub|k>
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|3<space|2spc>Inégalité
      maximale de Doob> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
