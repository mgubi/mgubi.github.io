...
<\body>
  ...
  Processus discrets>>|<cell|<small|<verbatim|[v.2 20110103]>>>>>>>
  ...
  <\exercise>
    ...
    <\enumerate-alpha>
      ...
      Soit <math|N<around|(|t|)>=<big-around|\<sum\>|<rsub|i\<geq\>1><with|math-font-family|bf|1><rsub|<around|{|T<rsub|i>\<leq\>t|}>>>>
  ...
  <\exercise>
    Soit <math|N<rsub|y>=<big-around|\<sum\>|<rsub|n\<geqslant\>1>1<rsub|X<rsub|n>=y>>>
  ...
  <\exercise>
    ...
    =<big-around|\<sum\>|<rsub|k=1><rsup|n>X<rsub|k>>> et
    ...
    <\enumerate-alpha>
      ...
      >A<rsub|n>:=<big-around|\<cap\>|<rsub|k\<geq\>1><big-around|\<cup\>|<rsub|n\<geq\>k>A<rsub|n>>>>
      ?
  ...
  <\exercise>
    ...
    <\enumerate>
      ...
      <\eqnarray>
        <tformat|<table|<row|<cell|<big-around|\<sum\>|<rsub|z\<in\>M>P<around|(|x,z|)>\<theta\><around|(|z|)>>>|<cell|=>|<cell|\<theta\><around|(|x|)><space|2em>x\<ne\>y<eq-number><label|inv>>>|<row|<cell|\<theta\><around|(|y|)>>|<cell|=>|<cell|1>>>>
      </eqnarray>
      ...
      <\eqnarray>
        <label|ex><big-around|\<sum\>|<rsub|z\<in\>M>P<around|(|x,z|)><wide|\<theta\>|~><around|(|z|)>>\<le\><wide|\<theta\>|~><around|(|x|)><space|2em>\<forall\>x\<in\>M
      </eqnarray>
  ...
  <\exercise>
    ...
    <\enumerate>
      ...
      <math|<with|math-display|true|N<rsub|n><around|(|x,y|)>=<with|math-font|Bbb|E><rsub|x><around*|[|<big-around|\<sum\>|<rsub|k=1><rsup|n>1<rsub|<around|{|X<rsub|k>=y|}>>>|]>>>.
  ...
  <\exercise>
    ...
    <\enumerate-numeric>
      ...
      <math|<big-around|\<sum\>|<rsub|0><rsup|\<infty\>>\<gamma\><rsub|n>>=\<infty\>>.
    </enumerate-numeric>
  </exercise>
  ...
  <\exercise>
    ...
    <\equation*>
      \<varphi\><rsub|U><around|(|t|)>=<big-around|\<sum\>|<rsub|z\<in\>Z<rsup|d>>e<rsup|-2\<pi\>i\<less\>z,t\<gtr\>>P<around|(|U=z|)>>
    </equation*>

    <\enumerate>
      <item>Vérifier que <math|P<around|(|U=z|)>=<big-around|\<int\>|<rsub|<around|[|0,1|)><rsup|d>>e<rsup|2\<pi\>i\<less\>z,t\<gtr\>>\<varphi\><rsub|U><around|(|t|)><space|0.75spc>d*t>>.

      <item>Soit <math|<around|(|U<rsub|j>|)><rsub|j\<ge\>1>> une suite de
      variables aléatoires i.i.d. à valeurs dans <math|\<bbb-Z\><rsup|d>>. On
      pose <math|X<rsub|0>=0,X<rsub|n>=<big-around|\<sum\>|<rsub|j=i><rsup|n>U<rsub|j>>>.
      Montrer que le point <math|0> est récurrent pour cette chaîne de Markov
      si et seulement si

      <\equation*>
        lim<rsub|\<lambda\>\<uparrow\>1<rsup|->><big-around|\<int\>|<rsub|<around|[|0,1|)><rsup|d>><with|math-font|cal|R>e<around*|(|<frac|1|1-\<lambda\>\<varphi\><around|(|t|)>>|)><space|0.75spc>\<mathd\>t>=+\<infty\>
      </equation*>
  ...
  <\exercise>
    ...
    <\enumerate>
      ...
      <\equation*>
        <with|math-font|Bbb|E><rsub|0><around*|(|<big-around|\<sum\>|<rsub|n=0><rsup|\<tau\><rsub|0>-1>1<rsub|<around|[|X<rsub|n>\<ge\>k|]>>>|)>
      </equation*>
