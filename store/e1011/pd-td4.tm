...
<\body>
  ...
  Processus discrets>>|<cell|<small|<verbatim|[v.1 20101122]>>>>>>>
  ...
  <\exercise>
    ...
    <\equation*>
      P(x,y)=<choice|<tformat|<table|<row|<cell|<frac|\<bbb-P\>(U<rsub|1>\<gtr\>x+1)|\<bbb-P\>(U<rsub|1>\<gtr\>x)>>|<cell|<text|si
      <math|y=x+1> ;>>>|<row|<cell|1-P(x,x+1)>|<cell|<text|si <math|y=0>
  ...
  <\exercise>
    ...
    particules sont choisie avec loi uniforme sur <math|{0,N}> et
    ...
    <\enumerate>
      ...
      <math|(x<rsup|i>)\<in\>M={0,1}<rsup|N>> où la <math|i<rsup|e>>
      composante <math|x<rsup|i>> vaut 1 ou 0 selon que la <math|i>-eme
      particule est dans la première ou la seconde enceinte.

      <\enumerate>
        <item>Montrer que <math|(X<rsub|n>)<rsub|n\<geqslant\>0>> est une
        chaîne de Markov sur <math|M> et donner sa matrice de transition.
      ...
      <\enumerate>
        ...
        <math|{0,N}> et donner sa matrice de transition.
