...
<\body>
  ...
  <\equation>
    <label|eq:2><big|sum><rsub|y\<in\>M>P<around|(|x,y|)>=1.
  </equation>
  ...
  <\equation>
    <label|eq:4>P*f<around|(|x|)>=<big|sum><rsub|y\<in\>M>P<around|(|x,y|)>f<around|(|y|)>=\<bbb-E\><rsub|x><around|[|f<around|(|X<rsub|1>|)>|]>.
  </equation>

  Soit <math|\<Pi\><around|(|M|)>=<around*|{|\<mu\>:M\<rightarrow\><around|[|0,1|]><space|0.75spc>,<big|sum><rsub|x\<in\>M>\<mu\><around|(|x|)>=1|}>>,
  l'ensemble des mesures de probabilité sur <math|M>. Pour toute
  <math|\<mu\>\<in\>\<Pi\><around|(|M|)>> on pose

  <\equation>
    <label|eq:5>\<mu\>P<around|(|x|)>=<big|sum><rsub|y\<in\>M>\<mu\><around|(|y|)>P<around|(|y,x|)>.
  </equation>
  ...
  <\equation>
    <label|eq:6>P<rsup|n+1><around|(|x,y|)>=<big|sum><rsub|z\<in\>M>P<around|(|x,z|)>P<rsup|n><around|(|z,y|)>.
  </equation>
  ...
  <\exercise>
    ...
    <\equation*>
      ...
      k\<geqslant\>1 : X<rsub|k>=y|)>\<leqslant\><big|sum><rsub|k\<geqslant\>1>P<rsup|k><around|(|x,y|)>.
    </equation*>
  </exercise>
  ...
  <\equation*>
    N<rsub|x>=<big|sum><rsub|n\<geqslant\>1>1<rsub|X<rsub|n>=x> .
  </equation*>
  ...
  <\remark>
    Pour tout v.a. <math|X> à valeurs dans
    <math|\<bbb-N\>=<around*|{|0,1,\<ldots\>|}>> on a que

    <\equation>
      \<bbb-E\><around|[|X|]>=\<bbb-E\><around|[|<big|sum><rsub|k\<geqslant\>0>1<rsub|k\<leqslant\>X>|]>=<big|sum><rsub|k\<geqslant\>0>\<bbb-P\><around|(|X\<geqslant\>k|)><label|eq:int-expectation>
    </equation>
  </remark>
  ...
  <\theorem>
    ...
    <\enumerate-roman>
      ...
      \ <big|sum><rsub|n\<geqslant\>1>P<rsup|n><around|(|x,x|)>=+\<infty\>>;

      <item><math|\<bbb-P\><rsub|x><around|(|T<rsub|x>\<less\>\<infty\>|)>\<less\>1
      \<Rightarrow\> <text|l'état <math|x> est transient \ et>
      \ <big|sum><rsub|n\<geqslant\>1>P<rsup|n><around|(|x,x|)>\<less\>+\<infty\>>
      .
    </enumerate-roman>
  ...
  <\proof>
    ...
    <\equation*>
      \<infty\>=\<bbb-E\><rsub|x><around|[|N<rsub|x>|]>=\<bbb-E\><rsub|x><around|[|<big|sum><rsub|n\<geqslant\>1>1<rsub|X<rsub|n>=x>|]>=<big|sum><rsub|n\<geqslant\>1>P<rsup|n><around|(|x,x|)>
      .
    </equation*>
    ...
    <\equation*>
      <big|sum><rsub|n\<geqslant\>1>P<rsup|n><around|(|x,x|)>=\<bbb-E\><rsub|x><around|[|N<rsub|x>|]>=<big|sum><rsub|n\<geqslant\>0>\<bbb-P\><rsub|x><around|(|N<rsub|x>\<geqslant\>n|)>=<big|sum><rsub|n\<geqslant\>0>f<rsub|x><rsup|n>=<frac|1|1-f<rsub|x>>\<less\>+\<infty\>
    </equation*>
  ...
  <\proof>
    ...
    <\equation*>
      <big|sum><rsub|k\<geqslant\>0>P<rsup|k><around|(|x,x|)>\<geqslant\><big|sum><rsub|k\<geqslant\>2N+2M>P<rsup|k><around|(|x,x|)>\<geqslant\>\<alpha\><big|sum><rsub|k\<geqslant\>N+M>P<rsup|k><around|(|y,y|)>\<geqslant\>\<alpha\><rsup|2><big|sum><rsub|k\<geqslant\>0>P<rsup|k><around|(|x,x|)>
    </equation*>
  ...
  <\proof>
    ...
    <\equation*>
      1=\<bbb-P\><rsub|x>(\<cap\><rsub|z\<in\>A><around|{|N<rsub|z>\<less\>+\<infty\>|}>)=\<bbb-P\><rsub|x><around|(|<big|sum><rsub|z\<in\>A>N<rsub|z>\<less\>+\<infty\>|)>=\<bbb-P\><rsub|x><around|(|<big|sum><rsub|n\<geqslant\>0>1<rsub|X<rsub|n>\<in\>A>\<less\>+\<infty\>|)>
    </equation*>
    ...
    <\equation*>
      ...
      X<rsub|n>\<in\>A|)>\<leqslant\>\<bbb-P\><rsub|x><around|(|<big|sum><rsub|n\<geqslant\>0>1<rsub|X<rsub|n>\<in\>A>=+\<infty\>|)>.
    </equation*>
  ...
  <\equation*>
    f<rsub|x y>=<big|sum><rsub|k\<geqslant\>1>\<bbb-P\><rsub|x><around|(|T<rsub|y><rsup|>=k|)>=<big|sum><rsub|k\<geqslant\>1>\<bbb-P\><rsub|x><around|(|A<rsub|1,k>|)>
  </equation*>

  <\equation*>
    =<big|sum><rsub|k\<geqslant\>1><big|sum><rsub|x<rsub|1>,\<ldots\>,x<rsub|k-1>\<neq\>y>P<around|(|x,x<rsub|1>|)>P<around|(|x<rsub|1>,x<rsub|2>|)>\<cdots\>P<around|(|x<rsub|k-1>,y|)>
  </equation*>
  ...
  <\equation*>
    \<bbb-P\><rsub|x><around|(|N<rsub|y>=r|)>=<big|sum><rsub|1\<leqslant\>n<rsub|1>\<less\>n<rsub|2>\<less\>\<cdots\>\<less\>n<rsub|r>>\<bbb-P\><rsub|x><around|(|A<rsub|1,n<rsub|1>>,A<rsub|n<rsub|1>+1,n<rsub|2>>,\<ldots\>,A<rsub|n<rsub|r-1>+1,n<rsub|r>>
    ,B<rsub|n<rsub|r>+1>|)>
  </equation*>
  ...
  <\equation*>
    \<bbb-P\><rsub|x><around|(|N<rsub|y>=r|)>=<big|sum><rsub|k<rsub|1>,\<ldots\>,k<rsub|r>\<geqslant\>1>\<bbb-P\><rsub|x><around|(|A<rsub|1,k<rsub|1>>|)>
  ...
  <\definition>
    ...
    <\equation>
      <label|eq:9>\<pi\><around|(|x|)>=<big|sum><rsub|y\<in\>M>\<pi\><around|(|y|)>P<around|(|y,x|)>,<space|2em>\<forall\><space|0.75spc>x\<in\>M.
    </equation>
  </definition>
  ...
  <\proof>
    ...
    <\equation*>
      <wide|\<mu\>|^><rsub|n>P-<wide|\<mu\>|^><rsub|n>=<frac|1|n><big|sum><rsub|k=0><rsup|n-1><around*|(|\<mu\>P<rsup|k+1>-\<mu\>P<rsup|k>|)>=<frac|1|n><around*|(|\<mu\>P<rsup|n>-\<mu\>|)>\<longrightarrow\><rsub|n\<to\>\<infty\>>0.
    </equation*>
  ...
  <\proposition>
    <label|prop:irred>Soit <math|P> une matrice de transition irréductible
    pour une chaîne de Markov et supposons qu'il existe une mesure
    stationnaire <math|\<pi\>>. Alors

    <\enumerate>
      <item><label|pi><math|\<pi\><around|(|x|)>\<gtr\>0> pour tout
      <math|x\<in\>M>,

      <item><label|cost>Pour tout <math|f:M\<rightarrow\>\<bbb-R\>> telle que
      <math|<big|sum><rsub|x\<in\>M>\<pi\><around|(|x|)>f<around|(|x|)><rsup|2>\<less\>+\<infty\>>
      on a que \ <math|P*f=f> <math|\<Rightarrow\>>
  ...
  <\proof>
    ...
    <\equation*>
      \<pi\><around|(|y|)>=<big|sum><rsub|z\<in\>M>\<pi\><around|(|z|)>P<rsup|k><around|(|z,y|)>\<ge\>\<pi\><around|(|x|)>P<rsup|k><around|(|x,y|)>\<gtr\>0,
    </equation*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|>|<cell|>|<cell|<big|sum><rsub|x,y\<in\>M>\<pi\><around|(|x|)>P<around|(|x,y|)><around*|(|f<around|(|x|)>-f<around|(|y|)>|)><rsup|2>>>|<row|<cell|>|<cell|>|<cell|=2<big|sum><rsub|x\<in\>M>\<pi\><around|(|x|)>f<around|(|x|)><rsup|2>-2<big|sum><rsub|x,y\<in\>M>\<pi\><around|(|x|)>P<around|(|x,y|)>f<around|(|x|)>f<around|(|y|)>>>|<row|<cell|>|<cell|>|<cell|=2<big|sum><rsub|x\<in\>M>\<pi\><around|(|x|)>f<around|(|x|)><around*|(|f<around|(|x|)>-<big|sum><rsub|y\<in\>M>P<around|(|x,y|)>f<around|(|y|)>|)>=0.>>>>
    </eqnarray*>

    On remarque que ces manipulations sont admises car

    <\equation*>
      <big|sum><rsub|x\<in\>M>\<pi\><around|(|x|)><around*|(|P
      f|)><around|(|x|)><rsup|2>\<leqslant\><big|sum><rsub|x\<in\>M>\<pi\><around|(|x|)>f<around|(|x|)><rsup|2>\<less\>+\<infty\>
    </equation*>

    par hypothése. Donc <math|\<forall\>x,y\<in\>M>
  ...
  <\equation>
    <label|eq:12>N<rsub|x><rsup|y>=<big|sum><rsub|n=0><rsup|T<rsub|x>-1>1<rsub|<around|[|X<rsub|n>=y|]>>.
  </equation>
  ...
  <\remark>
    ...
    <\enumerate-numeric>
      ...
      <item><math|<big|sum><rsub|y\<in\>M>N<rsub|x><rsup|y>=T<rsub|x>>.
    </enumerate-numeric>
  </remark>
  ...
  <\equation>
    \<mu\><rsub|x><around|(|y|)>=<with|math-font|Bbb|E><rsub|x><around|[|N<rsub|x><rsup|y>|]>=\<bbb-E\><rsub|x><around|[|<big|sum><rsub|n\<geqslant\>0>1<rsub|T<rsub|x>\<gtr\>n,X<rsub|n>=y>|]><label|eq:mufirsteqn>
  </equation>
  ...
  <\equation>
    <label|tot>\<mu\><rsub|x><around|(|M|)>=<big|sum><rsub|y\<in\>M>\<mu\><rsub|x><around|(|y|)>=<with|math-font|Bbb|E><rsub|x><around|(|T<rsub|x>|)>\<in\><around*|[|0,\<infty\>|]>.
  </equation>
  ...
  <\proposition>
    ...
    <\equation*>
      \<mu\><rsub|x><around|(|y|)>=<big|sum><rsub|z\<in\>M>\<mu\><rsub|x><around|(|z|)>P<around|(|z,y|)>.
    </equation*>
  </proposition>
  ...
  <\proof>
    ...
    <\equation*>
      \<mu\><rsub|x><around|(|y|)>=\<bbb-E\><rsub|x><around|[|<big|sum><rsub|n\<geqslant\>0>1<rsub|T<rsub|x>\<gtr\>n,X<rsub|n>=y>|]>=\<bbb-E\><rsub|x><around|[|<big|sum><rsub|n\<geqslant\>1>1<rsub|T<rsub|x>\<geqslant\>n,X<rsub|n>=y>|]>
    </equation*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<style-only*|\<mu\><rsub|x><around|(|y|)>>>|<cell|=>|<cell|<big|sum><rsub|n\<geqslant\>1>\<bbb-E\><rsub|x><around|[|1<rsub|T<rsub|x>\<geqslant\>n,X<rsub|n>=y>
      <big|sum><rsub|z\<in\>M>1<rsub|X<rsub|n-1>=z>|]><space|2em><text|(car
      <math|<big|sum><rsub|z\<in\>M>1<rsub|X<rsub|n-1>=z>=1>)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|x\<in\>M><big|sum><rsub|n\<geqslant\>1>\<bbb-E\><rsub|x><around|[|1<rsub|T<rsub|x>\<geqslant\>n>1<rsub|X<rsub|n>=y>1<rsub|X<rsub|n-1>=z>|]>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|x\<in\>M><big|sum><rsub|n\<geqslant\>1>P<around|(|z,y|)>*\<bbb-E\><rsub|x><around|[|1<rsub|T<rsub|x>\<geqslant\>n>
      1<rsub|X<rsub|n-1>=z>|]>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|x\<in\>M>P<around|(|z,y|)>
      <wide*|<big|sum><rsub|k\<geqslant\>0>*\<bbb-E\><rsub|x><around|[|1<rsub|T<rsub|x>\<gtr\>k>
      1<rsub|X<rsub|k>=z>|]>|\<wide-underbrace\>><rsub|=\<mu\><rsub|x><around|(|z|)><text|
      (par l'eq. (<reference|eq:mufirsteqn>))>><space|2em><around|(|<text|où
      on pose >k = n-1|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|z\<in\>M>P<around|(|x,z|)>
      \<mu\><rsub|x><around|(|z|)>>>>>
    </eqnarray*>
  </proof>
  ...
  <\proof>
    ...
    <\equation*>
      1=\<mu\><rsub|x><around|(|x|)>=<big|sum><rsub|z\<in\>M>\<mu\><rsub|x><around|(|z|)>P<rsup|k><around|(|z,x|)>\<ge\>\<mu\><rsub|x><around|(|y|)>P<rsup|k><around|(|y,x|)>
    </equation*>
  ...
  <math|x> on a que <math|\<bbb-E\><rsub|y><around|[|T<rsub|y>|]>=<big|sum><rsub|z\<in\>M>\<mu\><rsub|y><around|(|z|)>=C<rsub|x,y><big|sum><rsub|z\<in\>M>\<mu\><rsub|x><around|(|z|)>=C<rsub|x,y>\<bbb-E\><rsub|x><around|[|T<rsub|x>|]>\<less\>+\<infty\>>
  ...
  <\corollary>
    Soit <math|N<rsub|x>=<big|sum><rsub|n=0><rsup|\<infty\>>1<rsub|<around|[|X<rsub|n>=x|]>>>.
  ...
  <\theorem>
    ...
    <\equation>
      <label|eq:therg><with|math-font|Bbb|P><rsub|x><around*|(|lim<rsub|n\<to\>\<infty\>><frac|1|n><big|sum><rsub|k=0><rsup|n-1>1<rsub|<around|[|X<rsub|k>=y|]>>=\<pi\><around|(|y|)>|)>=1.
    </equation>
  </theorem>
  ...
  <\proof>
    ...
    <\equation*>
      <frac|1|k><big|sum><rsub|i=1><rsup|k-1>\<tau\><rsup|i><rsub|y><below|\<longrightarrow\>|k\<rightarrow\>\<infty\>>\<bbb-E\><rsub|y><around|(|T<rsub|y>|)>=<frac|1|\<pi\><around|(|y|)>><space|2em><with|math-font|Bbb|P><rsub|x>-p.s.
    </equation*>
    ...
    <\equation*>
      <frac|1|k>T<rsub|y><rsup|k>=<frac|1|k><around*|(|<big|sum><rsub|i=1><rsup|k-1>\<tau\><rsup|i><rsub|y>+T<rsub|y>|)><below|\<longrightarrow\>|k\<rightarrow\>\<infty\>><with|math-font|Bbb|E><rsub|y><around|(|T<rsup|1><rsub|y>|)>=\<pi\><around|(|y|)><rsup|-1><space|2em><with|math-font|Bbb|P><rsub|x>-p.s.
    </equation*>

    Par ailleurs, si pour tout <math|n\<ge\>1> on pose
    <math|N<rsub|y><rsup|n>=<big|sum><rsub|k=0><rsup|n-1>1<rsub|<around|[|X<rsub|k>=y|]>>>
    alors on a que
    ...
    <\equation*>
      <frac|N<rsup|n><rsub|y>|T<rsup|N<rsup|n><rsub|y>+1><rsub|y>>\<leqslant\><frac|1|n><big|sum><rsub|k=0><rsup|n-1>1<rsub|<around|[|X<rsub|k>=y|]>>\<leqslant\><frac|N<rsup|n><rsub|y>|T<rsup|N<rsup|n><rsub|y>><rsub|x>>.
    </equation*>
  ...
  <\corollary>
    ...
    <math|<big|sum><rsub|x\<in\>M><around|\||f<around|(|x|)>|\|>\<pi\><around|(|x|)>\<less\>\<infty\>>.
    Alors

    <\equation*>
      lim<rsub|n\<to\>\<infty\>><frac|1|n><big|sum><rsub|k=0><rsup|n-1>f<around|(|X<rsub|k>|)>=<big|sum><rsub|x\<in\>M>f<around|(|x|)>\<pi\><around|(|x|)><space|2em><with|math-font|Bbb|P><rsub|x>-p.s.
    </equation*>
  </corollary>
  ...
  <\equation*>
    <frac|1|n><big|sum><rsub|j=0><rsup|n-1>\<mu\>P<rsup|j>\<longrightarrow\><rsub|n\<to\>\<infty\>><rsup|loi>\<pi\>,
  </equation*>
