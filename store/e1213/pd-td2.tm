...
<\body>
  ...
  Processus discrets>>|<cell|<small|<verbatim|[v.2 20121022]>>>>>>>
  ...
  <\exercise>
    ...
    <\equation*>
      A<rsub|n>=<big|sum><rsub|i=1><rsup|n><with|math-font|Bbb|E><around*|(|<around|[|\<Delta\>*M<rsub|i>|]><rsup|2>\|<with|math-font|cal|F><rsub|i-1>|)>
    </equation*>
  ...
  <\exercise>
    (<name|inegalité de Lundberg>) Soit <math|<around*|(|X<rsub|n>|)><rsub|n\<geqslant\>0>>
    une suite de v.a. iid. On suppose qu'il existe <math|R\<gtr\>0> tel que
    <math|\<bbb-E\><around*|[|e<rsup|R*X<rsub|1>>|]>=1>. Soit
    <math|S<rsub|n>=X<rsub|1>+\<cdots\>+X<rsub|n>>. On veut montrer que pour
    tout <math|\<ell\>\<geqslant\>0> on a\ 

    <\equation*>
      \<bbb-P\><around*|(|max<rsub|0\<leqslant\>k\<leqslant\>n>S<rsub|k>\<geqslant\>\<ell\>|)>\<leqslant\>e<rsup|-R*\<ell\>>.
    </equation*>

    <\enumerate-alpha>
      <item>Montrer que le processus <math|<around*|(|M<rsub|n>|)><rsub|n\<geqslant\>0>>
      donné par <math|M<rsub|n>=e<rsup|R*S<rsub|n>>> pour
      <math|n\<geqslant\>1> et <math|M<rsub|0>=1> est une martingale par
      rapport à la filtration <math|<around*|(|\<cal-F\><rsub|n>|)><rsub|n\<geqslant\>0>>
      donnée par <math|\<cal-F\><rsub|n>=\<cal-F\><rsub|n><rsup|X>=\<sigma\><around*|(|X<rsub|1>,\<ldots\>,X<rsub|n>|)>>
      avec <math|\<cal-F\><rsub|0>=<around*|{|\<varnothing\>,\<Omega\>|}>>.

      <item>Montrer que <math|T=inf<around*|{|n\<geqslant\>0 :
      S<rsub|n>\<geqslant\>\<ell\>|}>> est un temps d'arrêt pour
      <math|<around*|(|\<cal-F\><rsub|n>|)><rsub|n\<geqslant\>0>>.

      <item>Montrer que <math|\<bbb-P\><around*|(|max<rsub|0\<leqslant\>k\<leqslant\>n>S<rsub|k>\<geqslant\>\<ell\>|)>\<leqslant\>\<bbb-E\><around*|[|M<rsub|n\<wedge\>T>|]>e<rsup|-R\<ell\>>>
      et conclure.
    </enumerate-alpha>
  </exercise>
  ...
  <\exercise>
    ...
    <\enumerate-alpha>
      ...
      <item>On suppose dans cette question et dans la suivante que
      <math|p=q=1/2>. Montrer que <math|<around|(|S<rsub|n>|)><rsub|n\<geqslant\>0>>
      est une martingale.
