...
<\body>
  ...
  exam 1 \|<space|0.2spc> v.1 20100415 ]>>
  ...
  <\enumerate-alpha>
    ...
    <\equation*>
      p<rsub|n,\<varepsilon\>>=\<bbb-P\><left|(><left|\|><frac|S<rsub|k>|n>-<frac|1|2><left|(><frac|k|n><right|)><rsup|2><right|\|>\<leqslant\>\<varepsilon\><space|1em>for
    ...
    <\equation*>
      limsup<rsub|n\<rightarrow\>+\<infty\>><left|\|>(p<rsub|n,\<varepsilon\>>)<rsup|1/n>-<frac|<sqrt|e>|2><right|\|>\<rightarrow\>0<space|2em>as
      \ \<varepsilon\>\<rightarrow\>0+ .
    </equation*>

    Hint: use Proposition 10 of Poly 3.
