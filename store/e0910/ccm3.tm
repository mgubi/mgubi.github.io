...
<\body>
  ...
  <\proof>
    ...
    <\equation*>
      =<big|sum><rsub|y\<in\>\<cal-M\>>P<rsub|n,a>(x,y)V<rsup|<wide|u|~>>(k+1,y)=P*V<rsup|<wide|u|~>>(k,x,a).
    </equation*>

    Cela nous donne que

    <\equation*>
      V(k,x)=inf<rsub|u\<in\>\<cal-C\><rsub|k>>V<rsup|u>(k,x)=inf<rsub|u\<in\>\<cal-C\><rsub|k>>[c(k,x,a)+P*V<rsup|<wide|u|~>>(k,x,a)].
    </equation*>

    Optimiser sur <math|u\<in\>\<cal-C\><rsub|k>> est équivalent à optimiser
    la choix initiale <math|a=u<rsub|k>(x)> et le contrôle
    <math|<wide|u|~>\<in\>\<cal-C\><rsub|k+1>> qui donne la stratégie sur les
    étapes suivantes donc

    <\equation*>
      V(k,x)=inf<rsub|a\<in\>\<cal-A\>>inf<rsub|<wide|u|~>\<in\>\<cal-C\><rsub|k>>[c(k,x,a)+P*V<rsup|<wide|u|~>>(k,x,a)]=inf<rsub|a\<in\>\<cal-A\>>[c(k,x,a)+P(inf<rsub|<wide|u|~>\<in\>\<cal-C\><rsub|k>>*V<rsup|<wide|u|~>>)(k,x,a)]
    </equation*>

    <\equation*>
      =inf<rsub|a\<in\>\<cal-A\>>[c(k,x,a)+(P*V)(k,x,a)]
    </equation*>
  ...
  <\lemma>
    <label|lemme:homog>Si la fonction de coût et la fonction <math|G> ne
    dépendants pas du temps, c-à-d si
  ...
  <\example>
    ...
    <\equation*>
      G(x,a,\<varepsilon\>)=<choice|<tformat|<table|<row|<cell|x+\<varepsilon\>>|<cell|<with|mode|text|si
      <math|x\<in\>\<bbb-R\>, a=0>>>>|<row|<cell|\<Delta\>>|<cell|<with|mode|text|si
      <math|x\<in\>\<bbb-R\>, a=1>>>>|<row|<cell|\<Delta\>>|<cell|<with|mode|text|si
      <math|x=\<Delta\>>>>>>>>
    </equation*>
  ...
  Ici on considère un processus contrôlé homogène, une fonction coût homogène
  <math|c:\<cal-M\>\<times\>\<cal-A\>\<rightarrow\>\<bbb-R\><rsub|>> (non
  nécessairement positive) et bornée <math|\|c(x,a)\|\<leqslant\>C\<less\>\<infty\>>
  et une constante <math|\<beta\>\<in\>]0,1]>. Si
  ...
  <\equation*>
    \|V<rsup|u><rsub|n>(x)-V<rsup|u>(x)\|\<leqslant\><big|sum><rsub|m\<geqslant\>n>\<beta\><rsup|m>C=C<frac|\<beta\><rsup|n>|1-\<beta\>>=\<varepsilon\><rsub|n>\<rightarrow\>0
  </equation*>

  si <math|n\<rightarrow\>\<infty\>>, c'est à dire\ 

  <\equation*>
    V<rsup|u><rsub|n>(x)-\<varepsilon\><rsub|n>\<leqslant\>V<rsup|u>(x)\<leqslant\>V<rsup|u><rsub|n>(x)+\<varepsilon\><rsub|n>
  </equation*>

  pour tout <math|n\<geqslant\>0>. En optimisant sur <math|u> on obtient de
  même

  <\equation*>
    V<rsub|n>(x)-\<varepsilon\><rsub|n>\<leqslant\>V(x)\<leqslant\>V<rsub|n>(x)+\<varepsilon\><rsub|n>
  </equation*>

  ce qui nous donne aussi\ 

  <\equation*>
    \|V<rsub|n>(x)-V(x)\|\<leqslant\>\<varepsilon\><rsub|n>\<rightarrow\>0.
  </equation*>
  ...
  <\proof>
    On considère le problème non-homogène d'optimisation associé à la
    fonction

    <\equation*>
      W<rsup|u><rsub|n>(k,x)=\<bbb-E\><rsup|u><rsub|(k,x)><big|sum><rsub|m=k><rsup|n-1>d(m,X<rsub|m>,U<rsub|m>)
    </equation*>

    avec <math|d(n,x,a)=\<beta\><rsup|n>c(x,a)> et
    <math|u\<in\>\<cal-C\><rsub|k>>. On remarque que
    <math|W<rsup|u><rsub|n>(0,x)=V<rsup|u><rsub|n>(x)>. L'équation de Bellman
    associé a <math|W<rsub|n+1>(k,x)=inf<rsub|u\<in\>\<cal-C\><rsub|k>>W<rsup|u><rsub|n+1>(k,x)>
    est

    <\equation*>
      W<rsub|n+1>(k,x)=inf<rsub|a\<in\>\<cal-A\>>[d(k,x,a)+P[*W<rsub|n+1>(k+1,\<cdot\>)](x,a)]
    </equation*>

    car le processus est homogène et donc le probabilités de transition ne
    dépendent pas du temps. Or pour <math|k=0> on a que

    <\equation*>
      W<rsup|u><rsub|n+1>(1,x)=\<bbb-E\><rsup|u><rsub|(1,x)><big|sum><rsub|m=1><rsup|n>d(m,X<rsub|m>,U<rsub|m>)
    </equation*>

    pour <math|u\<in\>\<cal-C\><rsub|1>>. Par le même argument utilisé dans
    la preuve du lemme <reference|lemme:homog> sur l'homogénéité, on a que
    cette quantité est équivalent à

    <\equation*>
      W<rsup|u><rsub|n+1>(1,x)=\<bbb-E\><rsup|<wide|u|~>><rsub|(0,x)><big|sum><rsup|n><rsub|m=0>d(m+1,X<rsub|m>,U<rsub|m>)=\<beta\>\<bbb-E\><rsup|<wide|u|~>><rsub|(0,x)><big|sum><rsub|m=0><rsup|n-1>d(m,X<rsub|m>,U<rsub|m>)=\<beta\>W<rsup|<wide|u|~>><rsub|n>(0,x)
    </equation*>

    où <math|<wide|u|~>\<in\>\<cal-C\><rsub|0>> est défini par
    <math|<wide|u|~><rsub|k>(x<rsub|0>,\<ldots\>,x<rsub|k>)=u<rsub|k+1>(x<rsub|0>,\<ldots\>,x<rsub|k>)>
    pour tout <math|k\<geqslant\>0> et \ <math|u\<in\>\<cal-C\><rsub|1>>.
    Donc

    <\equation*>
      W<rsub|n+1>(1,x)=inf<rsub|u\<in\>\<cal-C\><rsub|1>>W<rsup|u><rsub|n+1>(1,x)=inf<rsub|<wide|u|~>\<in\>\<cal-C\><rsub|0>>\<beta\>W<rsup|<wide|u|~>><rsub|n>(0,x)=\<beta\>
      W<rsub|n>(0,x)=\<beta\>*V<rsub|n>(x)
    </equation*>

    ce qui donne l'équation

    <\equation*>
      V<rsub|n+1>(x)=W<rsub|n+1>(0,x)=inf<rsub|a\<in\>\<cal-A\>>[d(0,x,a)+\<beta\>P*V<rsub|n>(x,a)].
    </equation*>
  ...
  <\remark>
    La même preuve peut être utilisé pour montrer que <math|V> est solution
    de

    <\equation*>
      V(x)=inf<rsub|a\<in\>\<cal-A\>>[c(x,a)+\<beta\>P*V(x,a)]<space|2em>x\<in\>\<cal-M\>.
    </equation*>

    Il suffit de considérer le cas <math|n=\<infty\>> dans l'argument.
  </remark>
  ...
  <\theorem>
    ...
    <\equation*>
      V(x)=[c+\<beta\>P*V](x,\<varphi\>(x)),<space|2em>x\<in\>\<cal-M\>
    </equation*>
  ...
  <\proof>
    ...
    <\equation*>
      \<bbb-E\>[M<rsub|n+1>-M<rsub|n>\|X<rsub|n>=y]=\<beta\><rsup|n>c(y,u(y))+\<beta\><rsup|n+1>P*F(y,u(y))-\<beta\><rsup|n>F(y)=0
    </equation*>
  ...
  <section|Contrôle en horizon infini: cas des coûts positifs>

  Dans cette section on fait l'hypothèse d'avoir des coûts
  <math|c:\<cal-M\>\<times\>\<cal-A\>\<rightarrow\>\<bbb-R\><rsub|+>>
  positifs et homogènes dans le problème de minimisation et on définit

  <\equation*>
    V<rsup|u>(x)=\<bbb-E\><rsup|u><rsub|(0,x)><big|sum><rsub|m\<geqslant\>0>c(X<rsub|m>,U<rsub|m>),<space|2em>V(x)=inf<rsub|u\<in\>\<cal-C\><rsub|0>>V<rsup|u>(x).
  </equation*>

  Comme dans le cas des gains positifs on a la convergence monotone des
  <math|V<rsup|u><rsub|n>(x)> vers <math|V<rsup|u>(x)>:

  <\equation*>
    V<rsup|u><rsub|n>(x)=\<bbb-E\><rsup|u><rsub|(0,x)><big|sum><rsub|m=0><rsup|n-1>c(X<rsub|m>,U<rsub|m>)\<nearrow\>V<rsup|u>(x)
  </equation*>

  pour <math|n\<rightarrow\>\<infty\>>.\ 

  <\theorem>
    Soit <math|\<cal-A\>> fini. Alors la fonction valeur <math|V> est la
    solution positive minimale de l'équation d'optimalité

    <\equation*>
      V(x)=min<rsub|a\<in\>\<cal-A\>>(c+P*V)(x,a),<space|2em>x\<in\>\<cal-M\>.
    </equation*>

    De plus, toute application <math|u:\<cal-M\>\<rightarrow\>\<cal-A\>>
    telle que

    <\equation*>
      V(x)=(c+P*V)(x,u(x)),<space|2em>x\<in\>\<cal-M\>
    </equation*>

    définit un contrôle markovien homogène qui est optimal pour tout état
    initiale <math|x\<in\>\<cal-M\>>.
  </theorem>

  <\proof>
    Par le principe de programmation dynamique la fonction <math|V> est
    solution de l'équation d'optimalité. Soit <math|F> un autre solution tel
    que <math|F(x)\<geqslant\>0>, par la finitude de <math|\<cal-A\>> il
    existe une application <math|<wide|u|~>:\<cal-M\>\<rightarrow\>\<cal-A\>>
    telle que

    <\equation*>
      F(x)=(c+P*F)(x,<wide|u|~>(x)),<space|2em>x\<in\>\<cal-M\>.
    </equation*>

    On a que

    <\equation*>
      F(x)=\<bbb-E\><rsub|(0,x)><rsup|<wide|u|~>>[M<rsub|0>]=\<bbb-E\><rsub|(0,x)><rsup|<wide|u|~>>[M<rsub|n>]=V<rsup|<wide|u|~>><rsub|n>(x)+\<bbb-E\><rsub|(0,x)><rsup|<wide|u|~>>[F(X<rsub|n>)]\<geqslant\>V<rsup|<wide|u|~>><rsub|n>(x)
    </equation*>

    et à la limite où <math|n\<rightarrow\>\<infty\>> on obtient
    <math|F(x)\<geqslant\>V<rsup|<wide|u|~>>(x)\<geqslant\>V(x)>. Si
    <math|F=V> on peut prendre <math|u=<wide|u|~>> et vérifier que
    <math|V\<geqslant\>V<rsup|u>> et donc que <math|u> donne un contrôle
    optimale.
  </proof>

  <\corollary>
    (Itération de la fonction valeur) Soit
    <math|V<rsub|n>(x)=inf<rsub|u\<in\>\<cal-C\><rsub|0>>V<rsup|u><rsub|n>(x)>.
    On a que <math|V<rsub|n>\<nearrow\>V>.
  </corollary>

  <\proof>
    Par convergence monotone on a que <math|V<rsub|\<infty\>>(x)=lim<rsub|n>V<rsub|n>(x)>
    est bien définie et positive. Par l'équation d'optimalité en horizon fini

    <\equation*>
      V<rsub|n+1>(x)=inf<rsub|a\<in\>\<cal-A\>>[c(x,a)+P*V<rsub|n>(x,a)]
    </equation*>

    et en prenant la limite pour <math|n\<rightarrow\>\<infty\>> on a que

    <\equation*>
      V<rsub|\<infty\>>(x)=inf<rsub|a\<in\>\<cal-A\>>[c(x,a)+P*V<rsub|\<infty\>>(x,a)]
    </equation*>

    mais alors <math|V<rsub|\<infty\>>\<geqslant\>V>. D'autre part
    <math|V<rsub|n>\<leqslant\>V<rsub|n><rsup|u>\<leqslant\>V<rsup|u>> et
    donc <math|V<rsub|\<infty\>>\<leqslant\>V<rsup|u>> et
    <math|V<rsub|\<infty\>>\<leqslant\>V> ce qui donne que
    <math|V<rsub|\<infty\>>=V>.\ 
  </proof>

  \;

  En pratique on peut donc trouver la fonction <math|V> par approximation
  avec des problèmes en horizon fini <math|V<rsub|n>>. On peut aussi chercher
  d'améliorer des politique de contrôle non optimales. En effet si
  <math|u:\<cal-M\>\<rightarrow\>\<cal-A\>> est un contrôle markovien alors
  on sait que

  <\equation*>
    V<rsup|u>(x)=(c+P*V<rsup|u>)(x,u(x)), <space|2em>x\<in\>\<cal-M\>
  </equation*>

  et si <math|V<rsup|u>> ne satisfait pas l'équation d'optimalité on peut
  trouver un contrôle <math|<wide|u|~>:\<cal-M\>\<rightarrow\>\<cal-A\>>
  meilleur dans le sens que

  <\equation*>
    V<rsup|u>(x)\<geqslant\>(c+P*V<rsup|u>)(x,<wide|u|~>(x)),<space|2em>x\<in\>\<cal-M\>
  </equation*>

  avec inégalité stricte pour un quelque <math|x<rsub|0>\<in\>\<cal-M\>>.
  Alors, évidemment, <math|V<rsup|u>\<geqslant\>V<rsup|<wide|u|~>><rsub|0>=0>
  et si on suppose que <math|V<rsup|u>\<geqslant\>V<rsup|<wide|u|~>><rsub|n>>
  on a

  <\equation*>
    V<rsup|u>(x)\<geqslant\>(c+P*V<rsup|u>)(x,<wide|u|~>(x))\<geqslant\>(c+P*V<rsup|<wide|u|~>><rsub|n>)(x,<wide|u|~>(x))=V<rsup|<wide|u|~>><rsub|n+1>(x)
  </equation*>

  ce qui donne que <math|><math|<math|V<rsup|u>\<geqslant\>V<rsup|<wide|u|~>><rsub|n>>>
  pour tout <math|n\<geqslant\>0> et donc que
  <math|V<rsup|u>\<geqslant\>V<rsup|<wide|u|~>>> avec une inégalité stricte
  pour <math|x<rsub|0>\<in\>\<cal-M\>>.

  \;

  <section|Optimisation de la moyenne sur des long temps>

  Ici on considère une fonction coût <math|c:\<cal-M\>\<times\>\<cal-A\>\<rightarrow\>\<bbb-R\>>
  bornée et on définit

  <\equation*>
    V<rsup|u><rsub|n>(x)=\<bbb-E\><rsup|u><rsub|(0,x)><big|sum><rsub|m=0><rsup|n-1>c(X<rsub|m>,U<rsub|m>),<space|2em>u\<in\>\<cal-C\><rsub|0>,x\<in\>\<cal-M\>
  </equation*>

  On dit que un contrôle <math|u> est optimale en démarrant de <math|x> si la
  limite

  <\equation*>
    \<lambda\>=lim<rsub|n\<rightarrow\>\<infty\>><frac|V<rsub|n><rsup|u>(x)|n>
  </equation*>

  existe et si pour tout autre contrôle <math|<wide|u|~>> on a que

  <\equation*>
    \<lambda\>\<leqslant\>liminf<rsub|n\<rightarrow\>\<infty\>><frac|V<rsub|n><rsup|<wide|u|~>>(x)|n>.
  </equation*>

  La valeur <math|\<lambda\>> est alors appelé le <em|coût minimale par unité
  de temps> en démarrant de <math|x>.

  <\theorem>
    Si il existe une constante <math|\<lambda\>> et une fonction bornée
    <math|\<theta\>:\<cal-M\>\<rightarrow\>\<bbb-R\>> tels que

    <\equation*>
      \<lambda\>+\<theta\>(x)\<leqslant\>(c+P*\<theta\>)(x,a),<space|2em>x\<in\>\<cal-M\>,a\<in\>\<cal-A\>.
    </equation*>

    Alors pour tout contrôle <math|u\<in\>\<cal-C\><rsub|0>> et tout
    <math|x\<in\>\<cal-M\>>,

    <\equation*>
      liminf<rsub|n\<rightarrow\>\<infty\>><frac|V<rsup|u>(x)|n>\<geqslant\>\<lambda\>.
    </equation*>
  </theorem>
  ...
  <\proof>
    ...
    <\equation*>
      M<rsub|n>=\<theta\>(X<rsub|n>)+<big|sum><rsub|k=0><rsup|n-1>c(X<rsub|k>,U<rsub|k>)-n*\<lambda\>.
    </equation*>

    Alors

    <\equation*>
      M<rsub|n+1>-M<rsub|n>=\<theta\>(X<rsub|n+1>)-\<theta\>(X<rsub|n>)+c(X<rsub|n>,U<rsub|n>)-\<lambda\>
    </equation*>

    et pour tout <math|y\<in\>\<cal-M\>>, <math|a\<in\>\<cal-A\>>:

    <\equation*>
      \<bbb-E\>[M<rsub|n+1>-M<rsub|n>\|X<rsub|n>=y,U<rsub|n>=a]=P*\<theta\>(y,a)-\<theta\>(y)+c(y,a)-\<lambda\>\<geqslant\>0
    </equation*>

    Donc

    <\equation*>
      \<theta\>(x)=\<bbb-E\><rsup|u><rsub|(0,x)>[M<rsub|0>]=\<bbb-E\><rsup|u><rsub|(0,x)>[M<rsub|n>]=\<bbb-E\><rsup|u>[\<theta\>(X<rsub|n>)]-n*\<lambda\>+V<rsup|u><rsub|n>(x)
    </equation*>

    et

    <\equation*>
      <frac|V<rsup|u><rsub|n>(x)|n>\<geqslant\>\<lambda\>+<frac|\<theta\>(x)|n>-<frac|\<bbb-E\><rsup|u>[\<theta\>(X<rsub|n>)]|n>\<rightarrow\>\<lambda\>
    </equation*>

    car <math|\<theta\>> est bornée.
  </proof>

  Un argument similaire donne

  <\theorem>
    Si il existe une constante <math|\<lambda\>>, une fonction bornée
    <math|\<theta\>> et un contrôle <math|u> tels que

    <\equation*>
      \<lambda\>+\<theta\>(x)\<geqslant\>(c+P*\<theta\>)(x,u(x)),<space|2em>x\<in\>\<cal-M\>
    </equation*>

    alors pour tout <math|x\<in\>\<cal-M\>>,

    <\equation*>
      limsup<rsub|n\<rightarrow\>\<infty\>><frac|V<rsup|u>(x)|n>\<leqslant\>\<lambda\>.
    </equation*>

    Donc si <math|\<lambda\>,\<theta\>> satisfont

    <\equation*>
      \<lambda\>+\<theta\>(x)=inf<rsub|a\<in\>\<cal-A\>>(c+P*\<theta\>)(x,a)
    </equation*>

    et si l'infimum est atteint à <math|u(x)> pour tout
    <math|x\<in\>\<cal-M\>> alors <math|u> est un contrôle optimal pour tout
    <math|x\<in\>\<cal-M\>>.
  </theorem>

  Soit <math|V<rsub|n>> la fonction valeur d'horizon fini donnée par
  <math|V<rsub|0>(x)=0> et <math|V<rsub|n+1>(x)=inf<rsub|a>(c+P*V<rsub|n>)(x,a)>.
  Soit

  <\equation*>
    \<lambda\><rsub|k><rsup|->=inf<rsub|x>{V<rsub|k+1>(x)-V<rsub|k>(x)}<space|2em>\<lambda\><rsub|k><rsup|+>=sup<rsub|x>{V<rsub|k+1>(x)-V<rsub|k>(x)}
  </equation*>

  <\theorem>
    Pour tout <math|k\<geqslant\>0> et tout contrôle <math|u> on a que

    <\equation*>
      liminf<rsub|n\<rightarrow\>\<infty\>><frac|V<rsup|u>(x)|n>\<geqslant\>\<lambda\><rsup|-><rsub|k>.
    </equation*>

    De pus, si il existe <math|u:\<cal-M\>\<rightarrow\>\<cal-A\>> tel que

    <\equation*>
      V<rsub|k+1>(x)=(c+P*V<rsub|k>)(x,u(x)),<space|2em>x\<in\>\<cal-M\>,
    </equation*>

    alors\ 

    <\equation*>
      limsup<rsub|n\<rightarrow\>\<infty\>><frac|V<rsup|u>(x)|n>\<leqslant\>\<lambda\><rsup|+><rsub|k>.
    </equation*>
  ...
  <\proof>
    ...
    <\equation*>
      \<lambda\><rsup|-><rsub|k>+V<rsub|k>(x)\<leqslant\>V<rsub|k+1>(x)\<leqslant\>(c+P*V<rsub|k>)(x,a),<space|2em>x\<in\>\<cal-M\>,
      a\<in\>\<cal-A\>
    </equation*>
    ...
    <\equation*>
      \<lambda\><rsup|+><rsub|k>+V<rsub|k>(x)\<geqslant\>V<rsub|k+1>(x)=(c+P*V<rsub|k>)(x,u(x)),<space|2em>x\<in\>\<cal-M\>,
    </equation*>

    et donc on peut appliquer les théorèmes précédentes avec
    <math|\<theta\>=V<rsub|k>>.
  </proof>
</body>
...
<\references>
  <\collection>
    ...
    <associate|eq:canon-1|<tuple|3|1>>
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|6<space|2spc>Contrôle
      en horizon infini: cas des coûts positifs>
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-7><vspace|0.5fn>

      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|7<space|2spc>Optimisation
      de la moyenne sur des long temps> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
