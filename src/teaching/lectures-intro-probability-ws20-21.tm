...
<\body>
  ...
  <notes-abstract|A bachelor course delivered online (due to the pandemic) in
  Bonn in the winter semester 2020/2021. In German.>\ 

  <with|font-series|bold|V2F1 - Einführung in die Wahrscheinlichkeitstheorie
  \U WS 2020/21>
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      <vspace*|2fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-size|<quote|1.19>|Introduction
      to probability> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
