...
<\body>
  ...
  Wednesday 12.15-14.00 and Thursday 12.15-14.00, Kleiner H�rsaal,
  Wegelerstr. 10<nbsp>

  Some lectures will also be held on Tuesday 16.00-18.00, <nbsp>Kleiner
  H�rsaal, Wegelerstr. 10.<nbsp>
  ...
  <\itemize>
    ...
    Girsanov transform, Bou�-Dupuis formula, Large deviations.
  ...
  <\itemize>
    ...
    <item>Lecture 8/6 : Entropy and Girsanov transform. F�llmer's drift. The
    Bou�-Dupuis formula.<nbsp>

    <item>Lecture 9/6 : proof of the Bou�-Dupuis formula, exponential
    ...
    <item>Lecture 15/6 : Proof of the Laplace principle via Bou�-Dupuis
    ...
    <item>Lecture 12/7 : Stratonovich's integral and relation with It�
    integral.
