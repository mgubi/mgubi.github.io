...
<\body>
  ...
  and L.<nbsp>Zambotti we organized a research period at the Netwon Institute
  in Cambridge to bring together people working in stochastic PDEs and people
  working around questions of stastistical mechanics and quantum field
  theory.>

  The <hlink|web page|https://www.newton.ac.uk/event/srq/> of the program

  <subsection*|Seminar notes>

  During the period we run a weekly seminar and I took notes from most of the
  talks. I gather them here in case they could be useful to other people and
  also to register the interesting atmosphere of the period where a wide
  variety of topics was discussed, trying to bridge across \Pcultural
  divides\Q.\ 

  <with|font-shape|italic|A word of warning: the notes were taken directly in
  <TeXmacs> during the seminar and I haven't attempted any later redaction
  (only a couple were checked by the speakers). The content reflects my
  understanding of the talk at the moment it was delivered. Only very minimal
  cosmetic changes were applied to conform to the style of the web site. Do
  not use them as reference material.>\ 
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      <vspace*|2fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-size|<quote|1.19>|<assign|chapter-numbered|false><assign|chapter-prefix|<macro|>><assign|section-nr|0><assign|subsection-nr|0><assign|subsubsection-nr|0><assign|paragraph-nr|0><assign|subparagraph-nr|0><flag|table
      of contents|dark green|what><assign|auto-nr|2><write|toc|<vspace*|2fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|font-size|<quote|1.19>|SRQ
      \U Scaling limits, rough paths, quantum field theory>
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      <no-break><pageref|auto-2><vspace|1fn>><toc-notify|toc-strong-1|SRQ \U
      Scaling limits, rough paths, quantum field
      theory><surround|<no-indent>|<specific|texmacs|<htab|0fn|first>>|<with|font-series|<quote|bold>|math-font-series|<quote|bold>|<vspace*|2fn><with|font-size|<quote|1.682>|SRQ
      \U Scaling limits, rough paths, quantum field
      theory<space|2spc>><vspace|1fn>><no-page-break><no-indent*>>>
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      ...
      <with|par-left|<quote|1tab>|Seminar notes
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
